...
INSERT INTO `college`(`code`, `name`,  `logo`)
VALUES ('CCS', 'College2','http://res.cloudinary.com/dugwbuzgu/image/upload/v1675062526/joscyjjl9yrsdzezgxra.png'
);
